"""Legacy VAE-GAN proof-of-concept - network definitions (superseded).
...
# Forked from ebadawy/voice_conversion/src/models.py
...
class Discriminator(nn.Module):
    def __init__(self, input_shape):
        ...
        # Height must be divisible by 16 (2^4 downsamples)
